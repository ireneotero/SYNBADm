...
%                 tol_nomad=tolc;
    ...
    case 'ipopt'
        ...
        ip_funcs.objective         = @ipopt_f;
        
        ip_funcs.gradient          = @eval_g_ipopt;
        
        ip_options.ipopt.hessian_approximation = 'limited-memory';
        ip_options.ipopt.mu_strategy           = 'adaptive';
        ip_options.ipopt.print_user_options='no';
        ip_options.print_level=dsp;
        ip_options.ipopt.nlp_scaling_method='gradient-based';
        ip_options.ipopt.print_options_documentation='no';
        ip_options.ipopt.acceptable_dual_inf_tol=tolc;
        ip_options.ipopt.acceptable_constr_viol_tol=tolc;
        ip_options.ipopt.max_iter=5;
        ip_options.ipopt.ma27_pivtol=tolc;
        ip_options.ipopt.tol=tolc;
        ip_options.ipopt.acceptable_tol=tolc;
        ip_options.ipopt.mu_init=1e-8;
        ip_options.ipopt.mu_min=tolc;
        ip_options.ipopt.bound_push=tolc;
        ip_options.ipopt.bound_frac=tolc;
        ip_options.ipopt.derivative_test='none';
        ip_options.ipopt.check_derivatives_for_naninf='no';
        
         [x status] = ipopt(x0,ip_funcs,ip_options);
...
%              'max_iter',5,...                   % Maximal number of iterations allowed (Integer, >=0)
...
% tolx=1e-9;
        ...
        options=optimset('LargeScale','off','Display',dsp,'Tolx',tolx,'TolFun',tolf,'Tolcon',tolg,'MaxSQPIter',200,'MaxFunEvals',200*nvar,'MaxIter',200*nvar);
