...
switch local_solver
    ...
    case {'n2fb','dn2fb'}
        ...
        if (nargout(fobj)<3 && ~isa(fobj,'function_handle'))
        ...
        if ~isempty(params)
            ...
            if(isa(fobj,'function_handle'))
                fprintf(fid,'global n2fb_function4fhandle; \n');
                global n2fb_function4fhandle;
                n2fb_function4fhandle=fobj;
                fprintf(fid,'[f,g,R]= %s(x,input_par{:});\n','n2fb_function4fhandle');                
            else
                fprintf(fid,'[f,g,R]= %s(x,input_par{:});\n',fobj);                
            end
        else
